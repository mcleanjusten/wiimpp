...
#define	WIIYOURSELF_VERSION_MINOR2	3
#define WIIYOURSELF_VERSION_BETA	// undefined for non-beta releases
#define WIIYOURSELF_VERSION_STR		_T("1.13 BETA")
...
class wiimote : public wiimote_state
	...
	public: // convenience accessors:
		...
		inline bool IsBalanceBoard	 () const { return (Internal.bExtension && (Internal.ExtensionType==wiimote_state::BALANCE_BOARD)); }
	...
	private: // methods
		...
		// initializes the MotionPlus extension when plugged in.
		void InitializeMotionPlusExtension
									();
	...
	private: // data
		...
		volatile bool	 bMotionPlus;	  // attempting to Connect a MotionPlus
