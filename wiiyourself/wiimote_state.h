...
enum state_change_flags
	...
	CLASSIC_CONNECTED			 = 1<<15,
	CLASSIC_BUTTONS_CHANGED		 = 1<<16,
	CLASSIC_JOYSTICK_L_CHANGED	 = 1<<17,
	CLASSIC_JOYSTICK_R_CHANGED	 = 1<<18,
	CLASSIC_TRIGGERS_CHANGED	 = 1<<19,
	//   all flags
	...
	//  Balance Board:
	BALANCE_CONNECTED			 = 1<<20,
	BALANCE_WEIGHT_CHANGED		 = 1<<21,
	//   all flags
	BALANCE_CHANGED				 = BALANCE_CONNECTED|BALANCE_WEIGHT_CHANGED,

	//  Motion Plus
	MOTIONPLUS_CONNECTED		 = 1<<22,
	MOTIONPLUS_SPEED_CHANGED	 = 1<<23,
	//   all flags
	MOTIONPLUS_CHANGED			 = MOTIONPLUS_CONNECTED|MOTIONPLUS_SPEED_CHANGED,
	...
	EXTENSION_CONNECTED			 = NUNCHUK_CONNECTED|CLASSIC_CONNECTED|
								   BALANCE_CONNECTED|MOTIONPLUS_CONNECTED,
	EXTENSION_CHANGED			 = EXTENSION_DISCONNECTED |
								   NUNCHUK_CHANGED|CLASSIC_CHANGED|BALANCE_CHANGED|
								   MOTIONPLUS_CHANGED,
	//  ALL flags:
